...
const BASE_PLAYER_SERVERS: BasePlayerServer[] = [
  ...
  { id: "vidspark", name: "VidSpark", domain: "vidspark.to", testUrl: "https://vidspark.to/movie/550", testTvUrl: "https://vidspark.to/tv/1399/1/1", supportsMovie: true, supportsTv: true, watchPartySupport: "full", compatibilityMessage: "Sincroniza play, pausa e avanço; a disponibilidade de áudio PT-BR depende do título" },
  ...
  { id: "cinesrc", name: "CineSrc", domain: "cinesrc.st", testUrl: "https://cinesrc.st/embed/movie/550", testTvUrl: "https://cinesrc.st/embed/tv/1399?s=1&e=1", supportsMovie: true, supportsTv: true, advertisingProfile: "minimal-declared", watchPartySupport: "full", compatibilityMessage: "Sincroniza play, pausa e avanço; a disponibilidade de áudio PT-BR depende do título" },
  ...
  { id: "moviesapi", name: "MoviesAPI", domain: "moviesapi.to", testUrl: "https://moviesapi.to/movie/550", testTvUrl: "https://moviesapi.to/tv/1399/1/1", supportsMovie: true, supportsTv: true, watchPartySupport: "full", compatibilityMessage: "Sincroniza play, pausa e avanço; a disponibilidade de áudio PT-BR depende do título" },
  { id: "vidzen", name: "VidZen", domain: "vidzen.fun", testUrl: "https://vidzen.fun/movie/550", testTvUrl: "https://vidzen.fun/tv/1399/1/1", supportsMovie: true, supportsTv: true, watchPartySupport: "full", compatibilityMessage: "Sincroniza play, pausa e avanço; a disponibilidade de áudio PT-BR depende do título" },

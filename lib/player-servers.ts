...
const BASE_PLAYER_SERVERS: Array<Omit<PlayerServerDefinition, "audioProfile" | "priority">> = [
  ...
  { id: "vidfast", name: "VidFast", domain: "vidfast.vc", testUrl: "https://vidfast.vc/movie/550?autoPlay=false&sub=pt", testTvUrl: "https://vidfast.vc/tv/1399/1/1?autoPlay=false&sub=pt", supportsMovie: true, supportsTv: true },
  ...
  { id: "megaembed-br", name: "MegaEmbed BR", domain: "mgeb.top", testUrl: "https://mgeb.top/embed/550", testTvUrl: "https://mgeb.top/embed/1399/1/1", supportsMovie: true, supportsTv: true },
  ...
  { id: "redeflix", name: "RedeFlix", domain: "redeflixapi.store", testUrl: "https://redeflixapi.store/filme/550", testTvUrl: "https://redeflixapi.store/serie/1399/1/1", supportsMovie: true, supportsTv: true },
